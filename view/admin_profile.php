...
$sql1="SELECT CONCAT (address ,', ' , brgy, ', ', municipality, ', ', province) AS address1 FROM admin WHERE index_number='$index'";
        	...
        	<div class="col-md-7">
            	<div class="panel"><!--panel bg-maroon--> 
                    ...
                    <div class="panel-body"><!--panel-body -->
                        ...
                        <p class="alert-info" id="note1"><strong>Note: We use the email address of the user for the username.</strong></p>
                     </div>
				...
				var xhttp1 = new XMLHttpRequest();//MSK-000131-Start Ajax  
					xhttp1.onreadystatechange = function() {		
						...
						if (this.readyState == 4 && this.status == 200) {
							...
							document.getElementById("address2").value =myArray[8];//MSK-000114
							document.getElementById("address3").value =myArray[9];//MSK-000114
							document.getElementById("address4").value =myArray[10];//MSK-000114
							...
							document.getElementById("user_name1").innerHTML =myArray[11];//MSK-000114
							document.getElementById("password1").value =myArray[12];//MSK-000114
							...
							$("form").submit(function (e){
								...
								var brgy = document.getElementById("address2").value;
								var municipality = document.getElementById("address3").value;
								var province = document.getElementById("address4").value;
								...
								if(full_name == '' || i_name == '' || address == '' || brgy == '' ||  municipality == '' || province == '' || phone == '' || telformat.test(phone) == false || email == '' || mailformat.test(email) == false || password == ''){
